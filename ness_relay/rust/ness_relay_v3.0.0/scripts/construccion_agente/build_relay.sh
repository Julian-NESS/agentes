...
# Phase 2.14: PROJECT_DIR debe apuntar a la RAÍZ del proyecto Cargo (un nivel
# arriba de scripts/construccion_agente/), porque el target/ del build está
# allí. Antes apuntaba a scripts/construccion_agente/, lo que causaba que
# el script buscara el binario en scripts/construccion_agente/target/, donde
# nunca se genera nada.
