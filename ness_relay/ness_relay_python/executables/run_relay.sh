...
#
# ═══════════════════════════════════════════════════════════
# NESS RELAY - Script de Ejecución
# Generado automáticamente el mar 24 mar 2026 08:36:26 -05
# ═══════════════════════════════════════════════════════════
...
# Suprimir warnings de APIs obsoletas (pkg_resources)
# Evita mensajes de deprecación de dependencias internas
...
if [ -t 1 ]; then
    ...
    echo ""
    ./executables/ness-relay-ubuntu --config /opt/ness_relay/configs/devices.conf
    EXIT_CODE=$?
    echo ""
    ...
    ./executables/ness-relay-ubuntu --config /opt/ness_relay/configs/devices.conf >> /opt/ness_relay/logs/ness_relay.log 2>&1
    EXIT_CODE=$?
